        ...
        <>
          <footer className="mt-20 w-full py-1 sm:py-4 px-4 sm:px-12 bg-primary-darkBlue text-white text-xs border-b border-gray-600 flex flex-col sm:flex-row overflow-hidden">
            ...
            <div className="w-full sm:w-5/12 my-6 mx-5 sm:mx-0 flex flex-col sm:flex-row gap-2 sm:gap-0 justify-between">
              <div className="w-full sm:w-1/2">
                ...
                <p className="mt-2 leading-5">Amamzon Internet Private Limited,<br />
                  Islamabad &<br />
                  
                  Shah Faisal Avenue, E-8, Islamabad<br />
                   44000<br />
                   Pakistan
                </p>
              </div>
              ...
              <div className="w-full sm:w-1/2">
                ...
                <p className="mt-2 leading-5">Amazon Internet Private Limited,<br />
                  Buildings Alyssa, Islamabad &<br />
                  Clove Embassy Tech Village,<br />
                  Shah Faisal Avenue, E-8, Islamabad,<br />
                  Islamabad, 44000,<br />
                  Pakistan <br />
                  CIN : U51109KA2012PTC066107<br />
                  Telephone: <a className="text-primary-blue" href="tel:18002029898">000 000 000</a>
                </p>
              </div>
            </div>
          ...
          <div className="px-16 py-6 w-full bg-primary-darkBlue hidden sm:flex justify-between items-center text-sm text-white">
            <a href="" target="_blank" rel="noreferrer" className="flex items-center gap-2">
              <span className="text-yellow-400"><WorkIcon sx={{ fontSize: "20px" }} /></span> Sell On Amazon
            </a>
            <a href="" target="_blank" rel="noreferrer" className="flex items-center gap-2">
            ...
            <span>&copy; 2007-{new Date().getFullYear()} Amazon.com</span>
