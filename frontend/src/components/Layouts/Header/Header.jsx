...
const Header = () => {
  ...
  return (
    ...
    <header className="bg-gray-700 fixed top-0 py-2.5 w-full z-10">
      ...
      <div className="w-full sm:w-9/12 px-1 sm:px-4 m-auto flex justify-between items-center relative">
        ...
        <div className="flex items-center flex-1 gap-12">
          <Link className="h-7 mr-1 sm:mr-4 -ml-28" to="/">
            <img draggable="false" className="h-full w-full object-contain mr-12" src="http://www.freelogovectors.net/wp-content/uploads/2016/12/amazon_logo.png" alt="Amazon Logo" />
          </Link>
        ...
        <div className="flex items-center justify-between ml-1 sm:ml-0 gap-0.5 sm:gap-7 relative">
          ...
          {isAuthenticated === false ?
            <Link to="/login" className="px-3 sm:px-9 py-0.5 text-gray-500 bg-white border font-medium rounded-sm cursor-pointer">Login</Link>
            :
            (
