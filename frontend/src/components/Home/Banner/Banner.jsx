...
import gadgetSale from '../../../assets/images/Banners/gadget-sale.png';
import kitchenSale from '../../../assets/images/Banners/kitchen-sale.png';
import poco from '../../../assets/images/Banners/poco-m4-pro.png';
...
const Banner = () => {
  ...
  return (
    <>
      <section className="h-72 sm:h-72 w-full rounded-sm shadow relative overflow-hidden">
        <Slider {...settings}>
          {banners.map((el, i) => (
            <img draggable="false" className="h-72 sm:h-72 w-full object-cover" src={el} alt="banner" key={i} />
          ))}
        </Slider>
      </section>
    </>
